    ...
    <div className="min-h-screen bg-muted p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" onClick={() => navigate('/admin/privacy')} className="gap-2">
            <Shield className="w-4 h-4" />
            Data Privacy
          </Button>
          <Button variant="outline" onClick={() => navigate('/admin/security')} className="gap-2" data-testid="security-alerts-nav-btn">
            <Activity className="w-4 h-4" />
            Security Alerts
          </Button>
          <Button variant="outline" onClick={() => navigate('/admin/saml-simulator')} className="gap-2" data-testid="saml-simulator-nav-btn">
            <Shield className="w-4 h-4" />
            SAML Simulator
          </Button>
