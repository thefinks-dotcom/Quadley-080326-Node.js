      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
          <div className="flex items-center gap-4">
            <Button onClick={() => navigate('/college-admin')} variant="ghost" size="icon" className="hover:bg-muted">
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={() => navigate('/college-admin/users/import')} variant="outline" className="flex items-center gap-2 h-10 border-border hover:bg-muted">
