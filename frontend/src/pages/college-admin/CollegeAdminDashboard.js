...
const CollegeAdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e) => {
      ...
      setKeySequence(prev => {
        ...
        // Check for shortcuts
        if (newSeq === 'ge') { navigate('/college-admin/events'); return ''; }
        if (newSeq === 'ga') { navigate('/college-admin/announcements'); return ''; }
        if (newSeq === 'gu') { navigate('/college-admin/users'); return ''; }
        if (newSeq === 'gs') { navigate('/college-admin/service-requests'); return ''; }
        if (newSeq === 'gr') { navigate('/college-admin/recognition'); return ''; }
        if (newSeq === 'gw') { navigate('/college-admin/wellbeing'); return ''; }
        if (newSeq === 'gc') { navigate('/college-admin/co-curricular'); return ''; }
        if (newSeq === 'gj') { navigate('/college-admin/jobs'); return ''; }
        if (newSeq === 'gm') { navigate('/college-admin/messages'); return ''; }
        if (newSeq === 'gh') { navigate('/college-admin'); return ''; }
  ...
  const quickActions = [
    { label: 'Create Announcement', icon: Megaphone, action: () => navigate('/college-admin/announcements'), color: 'text-primary' },
    { label: 'Post New Job', icon: Briefcase, action: () => navigate('/college-admin/jobs'), color: 'text-success' },
    { label: 'View Pending Requests', icon: Wrench, action: () => navigate('/college-admin/service-requests'), color: 'text-primary' },
    { label: 'Create Event', icon: Calendar, action: () => navigate('/college-admin/events'), color: 'text-primary' },
    { label: 'Safety Reports', icon: Shield, action: () => navigate('/college-admin/safety-support'), color: 'text-destructive' },
    { label: 'Send Recognition', icon: Award, action: () => navigate('/college-admin/recognition'), color: 'text-primary' },
    { label: 'View as Student', icon: Eye, action: () => navigate('/dashboard'), color: 'text-primary' },
  ];
          ...
          <div className="bg-white w-64 h-full shadow-xl p-4" onClick={e => e.stopPropagation()}>
            <nav className="space-y-2">
              {adminModules.map(module => (
                <button
                  key={module.id}
                  onClick={() => { navigate(module.path); setMobileMenuOpen(false); }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <Card 
                    ...
                    onClick={() => navigate('/college-admin/users')}
                  >
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        <div className="p-2 bg-gradient-to-br from-primary to-secondary rounded-xl">
                  ...
                  <Card 
                    className="cursor-pointer hover:shadow-lg hover:scale-[1.01] transition-all"
                    onClick={() => navigate('/college-admin/modules')}
                  >
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        <div className="p-2 bg-gradient-to-br from-primary to-secondary rounded-xl">
                  ...
                  <Card 
                    className="cursor-pointer hover:shadow-lg hover:scale-[1.01] transition-all"
                    onClick={() => navigate('/college-admin/sso')}
                  ...
                  <Card 
                    className="cursor-pointer hover:shadow-lg hover:scale-[1.01] transition-all"
                    onClick={() => navigate('/college-admin/privacy')}
                  ...
                  <Card 
                    className="cursor-pointer hover:shadow-lg hover:scale-[1.01] transition-all"
                    onClick={() => navigate('/college-admin/security')}
                  ...
                  <Card 
                    className="cursor-pointer hover:shadow-lg hover:scale-[1.01] transition-all"
                    onClick={() => navigate('/college-admin/reports')}
                  >
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
        ...
        <div className="mt-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <Button size="sm" variant="outline" className="text-xs h-8" onClick={() => navigate('/college-admin/events')}>
              Manage Events
            </Button>
          </div>
          {upcomingEventsList.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {upcomingEventsList.map(event => (
                <Card key={event.id} className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/college-admin/events')}>
                  <CardContent className="p-4">
                    ...
                    <div className="mb-4">
                      ...
                      {searchResults.users.map(user => (
                        <div
                          ...
                          onClick={() => { navigate('/college-admin/users'); setSearchOpen(false); }}
                        >
                    ...
                    <div className="mb-4">
                      ...
                      {searchResults.events.map(event => (
                        <div
                          key={event.id}
                          className="flex items-center gap-3 p-3 hover:bg-muted rounded-lg cursor-pointer"
                          onClick={() => { navigate('/college-admin/events'); setSearchOpen(false); }}
                        >
                    ...
                    <div className="mb-4">
                      ...
                      {searchResults.announcements.map(ann => (
                        <div
                          key={ann.id}
                          className="flex items-center gap-3 p-3 hover:bg-muted rounded-lg cursor-pointer"
                          onClick={() => { navigate('/college-admin/announcements'); setSearchOpen(false); }}
                        >
                          <div className="p-2 bg-muted rounded-lg">
                    ...
                    <div className="mb-4">
                      ...
                      {searchResults.groups.map(group => (
                        <div
                          key={group.id}
                          className="flex items-center gap-3 p-3 hover:bg-muted rounded-lg cursor-pointer"
                          onClick={() => { navigate('/college-admin/co-curricular'); setSearchOpen(false); }}
                        >
                          <div className="p-2 bg-muted rounded-lg">
