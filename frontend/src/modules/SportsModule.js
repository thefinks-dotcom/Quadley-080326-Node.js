...
const SportsModule = () => {
  ...
  const createGroup = async (e) => {
    ...
    try {
      ...
      toast.success('Sports group created!');
      setShowForm(false);
      setNewGroup({
        name: '',
        description: '',
  ...
  return (
    <div className="space-y-6" data-testid="sports-module">
      ...
      <div className="grid gap-4">
        {groups.map((group) => {
          ...
          const isHead = group.contact_person === user?.id;
          const isOwner = user?.id === group.owner_id;
          const canManage = isOwner || user?.role === 'admin';

          return (
            <Card key={group.id} className="p-6 glass">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><strong>Team Members:</strong> {group.members.length}</p>
              </div>
