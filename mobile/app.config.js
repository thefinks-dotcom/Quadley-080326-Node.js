...
// This file is imported directly by the app so the correct tenant values are
// ALWAYS available regardless of what env vars are set when Metro bundles JS.
// Re-run `TENANT=<code> npx expo prebuild` to regenerate for a different tenant.
